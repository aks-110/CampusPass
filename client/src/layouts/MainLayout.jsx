...
import { LogOut, Home, User, QrCode, FileText, Bell, Settings, Users, Building, ShieldAlert, BarChart3, Search, AlertTriangle, ShieldCheck } from 'lucide-react';
...
const MainLayout = ({ role }) => {
  ...
  // Guard against wrong role URL access
  if (user?.role !== role) {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#f8fafc] text-foreground font-sans overflow-hidden">
      ...
      <div className="bg-[#0e274b] text-white py-1.5 px-6 flex justify-between items-center text-[11px] font-semibold tracking-wide border-b border-[#05162e] shrink-0 z-20">
      ...
      <div className="bg-white py-3 px-6 border-b border-gray-200 shrink-0 z-20 shadow-sm">
      ...
      <div className="bg-[#1e4479] text-white py-2 text-center border-b-2 border-[#e5a93b] font-bold text-xs tracking-widest uppercase shadow-sm shrink-0 z-20">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <motion.aside 
          initial={{ x: -250 }}
          animate={{ x: 0 }}
          className="w-64 bg-card border-r border-border flex flex-col shadow-lg z-10 shrink-0"
        >
          ...
          <div className="p-4 border-t border-border bg-secondary/10 shrink-0">
            ...
            <div className="flex gap-2">
              <button 
                  onClick={toggleTheme}
                  className="flex-1 flex items-center justify-center py-2 bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-lg transition-colors shadow-sm text-xs"
              ...
              <button 
                  ...
                  className="flex-[3] flex items-center justify-center gap-2 py-2 text-xs font-bold text-destructive hover:bg-destructive hover:text-white border border-destructive/20 rounded-lg transition-colors shadow-sm"
              >
        ...
        {/* Main Content Area */}
        <main className="flex-grow flex flex-col overflow-hidden bg-[#f1f5f9]">
